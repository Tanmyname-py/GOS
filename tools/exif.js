...
import  * as Image  from 'node-webpmux'
...
async function imageToWebp(media) {
  const tmpFileOut = `./trash/${makeid(10)}.webp`
  const tmpFileIn = `./trash/${makeid(10)}.jpg`
...
async function videoToWebp(media) {
  const tmpFileOut = `/trash/${makeid(10)}.webp`
  const tmpFileIn = `/trash/${makeid(10)}.mp4`
...
async function writeExifImg(media, metadata) {
  ...
  const tmpFileIn = `./trash/${makeid(10)}.webp`
  const tmpFileOut = `./trash/${makeid(10)}.webp`
